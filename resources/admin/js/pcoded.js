...
const  layout_theme_contrast_change = (value)=> {
  if (value == true) {
...
$(document).on('click','.layout_caption_trigger',function (){
...
$(document).on('click','.layout-rtl-change',function (){
    let value = $(this).data('value');
...
$(document).on('click','.layout-change-trigger',function (){
    let value = $(this).data('value');
    layout_change(value);
})
function layout_change(layout) {
    ...
    if (layout == 'dark') {
        ...
        if (control) {
            ...
            document.querySelector(".theme-layout .btn[data-value='dark']").classList.add('active');
        }
    } else {
        dark_flag = false;
        ...
        if (control) {
            document.querySelector('.theme-layout .btn.active').classList.remove('active');
            document.querySelector(".theme-layout .btn[data-value='light']").classList.add('active');
        }
    }
}

$(document).on('click','.box-container-trigger',function (){
    let value = $(this).data('value');
...
$(document).on('click','.theme-contrast-trigger',function (){
    let value = $(this).data('value');
    layout_theme_contrast_change(value);
})
